...
public class LoginControllerTest {
  ...
  @Test
  public void registerValidUserReturnsValidRegisteredUser() throws Exception {
    ...
    ResponseEntity<?> response = loginController.register(registerUserDto);
  ...
  @Test
  public void registerExistingUserReturnsErrorBadRequestResponse() throws Exception {
    UserEntity registerUserDto = new UserEntity();
    registerUserDto.setEmail("existing@example.com");
    registerUserDto.setPassword("password");
    when(authenticationService.signup(any(UserEntity.class)))
  ...
  @Test
  public void authenticateValidLoginRequestReturnsValidJwtToken() throws Exception {
